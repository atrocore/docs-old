...
2. Open the drop-down menu of the module to be installed:
   ...
   ![call_dropdown](./_assets/module-manager/module_manager_drondown_en.png)

3. Click the "Install" button.

   ![install_module](./_assets/module-manager/module_manager_install_en.png)
...
4. To start the module(s) installation process, click on the button "Update" and confirm the action: 
   ...
   ![confirm_install](./_assets/module-manager/module_manager_confirm_en.png)
...
![settings_page](./_assets/module-manager/module_manager_settings_en.png)
