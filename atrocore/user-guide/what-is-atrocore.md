...
- [AtroPIM](../../atropim/user-guide/what-is-atropim.md)
- AtroCRM
- AtroDAM
...
Each entity in the system can have many records. These entity records can be managed and operated with on various [views](./views-and-panels.md) available in the AtroCore system.
